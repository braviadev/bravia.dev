...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to bravia.dev.
...
- **Website** refers to bravia.dev, accessible from [https://bravia.com](https://bravia.com)
